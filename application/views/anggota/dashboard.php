...
<script src="<?php echo base_url(); ?>assets/admin/js/plugins/flot/jquery.flot.time.js"></script>
...
<!-- Jvectormap -->
<script src="<?php echo base_url(); ?>assets/admin/js/plugins/jvectormap/jquery-jvectormap-2.0.2.min.js"></script>
