...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li>
                <a href="<?= base_url('pengurus/list_jadwal') ?>">Jadwal</a>
            </li>
            <li class="active">
                <strong>
                    <a>List Jadwal</a>
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        <button type="button" class="btn btn-primary pull-right" data-toggle="modal" data-target="#m_tambah">
                            <span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Atur Jadwal
                        </button>
                    </div>
                </div>
