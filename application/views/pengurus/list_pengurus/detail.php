<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li>
                <a href="<?= base_url('pengurus/list_pengurus') ?>">Pengurus</a>
            </li>
            <li class="active">
                <strong>
                    <a>Profil Pengurus</a>
                                ...
                                <div class="row">
                                    <div class="col-lg-5">
                                        <dl class="dl-horizontal">
                                            ...
                                            <dt>NPM:</dt>
                                            <dd><?php echo $data_pengurus->npm; ?></dd>
                                            <dt>Nama:</dt>
                                            <dd><?php echo $data_pengurus->nama; ?></dd>
                                            <dt>Tempat Tanggal Lahir:</dt>
                                            <dd><?php echo $data_pengurus->tempat_tgl_lahir; ?></dd>
                                        </dl>
                                    </div>
                                    <div class="col-lg-5">
                                        <dl class="dl-horizontal">
                                            ...
                                            <dt>Alamat:</dt>
                                            <dd><?php echo $data_pengurus->alamat; ?></dd>
                                            <dt>Email:</dt>
            ...
            <?php if ($FILE == "ADA") { ?>
                <div class="row">
                    <div class="col-lg-9 animated fadeInRight">
                        <div class="row">
                            <div class="col-lg-12">
                                <?php foreach ($dokumen as $pengurus) { ?>
                                    ...
                                    <div class="file-box">
                                        <div class="file">
                                            <a href="#">
                                                ...
                                                <?php if ($pengurus->ekstensi == "jpg" || $pengurus->ekstensi == "png" || $pengurus->ekstensi == "jpeg" || $pengurus->ekstensi == "bmp") {
                                                    echo ("<div class='image'>
												<img alt='image' class='img-responsive' 
												src='" . base_url() . $pengurus->keterangan_assets . "'></div>");
                                                } else {
                                                    echo ("<div class='icon'>
                                                ...
                                                <div class="file-name">
                                                    <a href="<?= base_url(); ?>assets/uploads/pengurus/<?= $pengurus->dok_file; ?>">Download file</a>
                                                    <br />
                                                    <small>Jenis file: <?= $pengurus->jenis_file; ?></small>
                                                    <br />
                                                    <small>Keterangan file: <?= $pengurus->keterangan_file; ?></small>
                                                    <br />
                                                    <small>Diupload: <?= $pengurus->tanggal_upload; ?></small>
                                                </div>
                                                <input type="button" class="btn btn-block btn-outline btn-danger" onclick="location.href='<?= base_url(); ?>index.php/pengurus/list_pengurus/hapus_file/<?= $pengurus->dok_file; ?>';" value="Hapus" />
...
<script>
    ...
    var file_upload = new Dropzone(".dropzone", {
        url: "<?= base_url('pengurus/list_pengurus/proses_upload_file') ?>",
        maxFilesize: 5,
        method: "post",
    ...
    file_upload.on("removedfile", function(a) {
        ...
        $.ajax({
            ...
            url: "<?php echo base_url('pengurus/list_pengurus/remove_file') ?>",
            cache: false,
            dataType: 'json',
            success: function() {
