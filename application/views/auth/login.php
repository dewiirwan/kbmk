...
<head>
    <!-- <link rel="icon" type="image/png" href="<?= base_url() ?>assets/admin/dist/images/DB_16х16.png"> -->
    <meta charset="utf-8">
                ...
                <div class="mdl-card__supporting-text color--dark-gray">
                    <div class="mdl-grid">
                        <div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-phone">
                            <span class="mdl-card__title-text text-color--smooth-gray">Login KBMK</span>
                        </div>
                        ...
                        <div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-phone">
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                                <input class="mdl-textfield__input" name="email" value="<?php echo set_value('email'); ?>" type="email" id="email">
                                <label class="mdl-textfield__label" for="email">Email</label>
                            </div>
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                                <input class="mdl-textfield__input" name="password" value="<?php echo set_value('password'); ?>" type="password" id="password">
                                <label class="mdl-textfield__label" for="password">Password</label>
                            </div>
                            <a href="<?php echo base_url(); ?>auth/lupa_password" class="login-link">Forgot password?</a>
                        </div>
                        <div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-phone submit-cell">
                            <a href="<?php echo base_url(); ?>index.php/auth/register" class="login-link">Don't have account?</a>
