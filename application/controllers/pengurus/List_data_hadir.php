...
class List_data_hadir extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->data['title'] = 'KBMK | List Data Hadir';
    }
    ...
    public function index()
    {
        ...
        $this->data['isi'] = 'pengurus/list_anggota/data_hadir';
    ...
    public function detail()
    {
        ...
        $this->data['message'] = (validation_errors()) ? validation_errors() : $this->session->flashdata('message');
        $this->data['message_deaktivasi'] = (validation_errors()) ? validation_errors() : $this->session->flashdata('message_deaktivasi');
        $this->data['isi'] = 'pengurus/list_anggota/detail_data_hadir';
        $this->data['id_group'] = $id_group->id_group;
